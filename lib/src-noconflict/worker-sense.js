...
ace.define("ace/mode/sense_worker", [
  "require",
  "exports",
  "module",
  "ace/lib/oop",
  "ace/worker/mirror",
  "ace/mode/sense/sense_parse"
], function(require, exports, module) {
...
ace.define("ace/mode/sense/sense_parse", ["require", "exports", "module"], function(
  require,
  exports,
  module
) {
  var at, // The index of the current character
    ...
    comments = {}, // The comments positions.
    annos, // annotations
    escapee = {
      '"': '"',
      "\\": "\\",
    ...
    comment = function() {
        while (ch && ch == '/' && comments.hasOwnProperty(at)) {
            at = comments[at];
            next();
            return true;
        }
      ...
      if (meth == "GET") {
        annotate(
          ...
          "Browsers do not support " +
            meth +
            " requests with a body. This will be executed as a POST."
        );
      }
      object();
    }
  ...
  return function(source, reviver) {
    ...
    text.split("\n").forEach((line) => {
        ...
        if (commentRegex.test(line.trimLeft())) {
            comments[start] = end;
        }
        end += 1;
    });
